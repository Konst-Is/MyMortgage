...
final class ViewController: UIViewController, Coordinatable, Storyboardable {
    ...
    override func viewDidLoad() {
        ...
        infoLabel.text = """
        Инфляция - это процесс общего роста цен и обесценивания денег. Но можно ли заставить её работать на себя? Это приложение ответит на вопрос, почему покупать недвижимость в кредит сегодня выгодно, несмотря на то, что придётся заплатить даже две и более стоимости квартиры.
